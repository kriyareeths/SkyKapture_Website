...
import studio1 from "../../assets/SkyKapture_OurStory_2.webp";
import studio2 from "../../assets/SkyKapture_OurStory_1.webp";
import counterBg from "../../assets/counter.webp";
import missionIcon from "../../assets/mission-icon.webp";
import founderImg from "../../assets/ceoimage.webp";
          ...
          <div className="studio-left-content">
            <div>
              ...
              <h2 className="studio-title tit">
               We design spaces that tell your story, where timeless elegance meets contemporary living.
              </h2>
            </div>
            ...
            <div className="second-div">
              ...
              <div className="studio-text-box">
                ...
                A design studio driven by precision, passion, and purpose. From intimate residential homes to ambitious commercial spaces, we transform visions into experiences that last a lifetime.
                </p>
        ...
        <div className="dashboard-container">
          <div className="dashboard-column col-1">
            <div className="dash-card white-card mission-card">
              ...
              />
              <p className="des">
                Every space we design is a step beyond what came before. We push boundaries, evolve our craft, and deliver interiors that are smarter, bolder, and more alive every single time.
              </p>
            </div>
          ...
          <div className="dashboard-column col-2">
            <div className="dash-card dark-card quote-feature-card">
              ...
              <p className="quote-text stit">
                EVERY GREAT HOME BEGINS WITH A BOLD VISION AND ENDS WITH A SPACE WORTH LIVING.
              </p>
          ...
          <div className="dashboard-column col-3">
            ...
            <div className="dash-card white-card vision-card">
              ...
              <p className="des">
                We craft interiors that don't just look stunning, they transform the way you live, work, and feel every single day.
              </p>
              <img
                src={visionHouse}
