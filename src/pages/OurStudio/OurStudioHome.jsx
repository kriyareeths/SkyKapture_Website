              ...
              <main className="studio-home-grid-layout" style={{ marginTop: 0 }}>
                ...
                <article className="studio-home-text-right">
                  <h1 className="studio-home-hero-heading Futura-font">
                    Designing spaces that speak before words do. Where precision meets passion, and every structure tells a story worth living in.
                  </h1>
                  <p className="studio-home-hero-description inter-font des">
                  Sky Kapture Interiors is a Coimbatore based design studio crafting residential and commercial spaces that are beautiful by design, built to last, and shaped entirely around you.
                  </p>
                  ...
                  <div className="studio-counter-container" style={{ marginTop: "4rem" }}>
                    ...
                    <div style={{ position: "relative", padding: "2.5rem 0", overflow: "hidden" }}>
                      ...
                      <motion.div style={{ y: yAll, display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                        <h2 className="studio-counter-metric-number" style={{ margin: 0, fontSize: "4rem", fontWeight: "400", color: "#111", display: "flex", alignItems: "center" }}>
                          <SlotCounter value={50} baseDirection="up" startRolling={startRolling} />
                    ...
                    <div style={{ position: "relative", padding: "2.5rem 0", overflow: "hidden" }}>
                      ...
                      <motion.div style={{ y: yAll, display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                        <h2 className="studio-counter-metric-number" style={{ margin: 0, fontSize: "4rem", fontWeight: "400", color: "#111", display: "flex", alignItems: "center" }}>
                          <SlotCounter value={4} baseDirection="up" startRolling={startRolling} />
                          <span className="studio-counter-metric-suffix" style={{ marginLeft: "5px" }}>+</span>
                        </h2>
                    ...
                    <div style={{ position: "relative", padding: "2.5rem 0", overflow: "hidden" }}>
                      ...
                      <motion.div style={{ y: yAll, display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                        <h2 className="studio-counter-metric-number" style={{ margin: 0, fontSize: "4rem", fontWeight: "400", color: "#111", display: "flex", alignItems: "center" }}>
                          <SlotCounter value={100} baseDirection="up" startRolling={startRolling} />
                          <span className="studio-counter-metric-suffix" style={{ marginLeft: "5px" }}>%</span>
                        </h2>
                        <div className="studio-counter-metric-text inter-font" style={{ fontSize: "16px", color: "#333", textAlign: "left" }}>
          ...
          <section className="studio-services-section">
            ...
            <div className="studio-services-grid">
              <div className="studio-services-card studio-services-border-right">
                ...
                <p className="studio-services-card-desc inter-font des">Sky Kapture creates bespoke architectural and interior designs that redefine modern living spaces</p>
              ...
              <div className="studio-services-card studio-services-border-right">
                ...
                <p className="studio-services-card-desc inter-font des">We deliver premium interior and architectural solutions tailored perfectly to your budget.</p>
              ...
              <div className="studio-services-card">
                ...
                <p className="studio-services-card-desc inter-font des">Precision, passion, and seamless execution define every space transformed by our team.</p>
