...
import imgMainHero from "../../../../src/assets/BPCL (7).webp";
import imgKitchenView from "../../../../src/assets/BPCL (6).webp";
import imgExteriorVilla from "../../../../src/assets/BPCL (5).webp";
import imgWarmNightView from "../../../../src/assets/BPCL (4).webp";
import slider1 from "../../../../src/assets/BPCL (3).webp";
import slider2 from "../../../../src/assets/BPCL (2).webp";
import slider3 from "../../../../src/assets/BPCL (1).webp";
import slider4 from "../../../../src/assets/BPCL (8).webp";
...
import firstimage from "../../../../src/assets/BPCL (1).webp";
import secondimage from "../../../../src/assets/BPCL (2).webp";
import sixthimage from "../../../../src/assets/skykaptureimage1.webp";
import thirdimage from "../../../../src/assets/BPCL (3).webp";
import fourthimage from "../../../../src/assets/BPCL (4).webp";
import fifthimage from "../../../../src/assets/BPCL (5).webp";

function BharatPetroleum() {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
          ...
          <div className="project-title-wrapper">
            ...
            <div className="client-loc-row">
              <div className="meta-inline-item">
                ...
                <span className="sdes jost-font">Bharat Petroleum</span>
              </div>
              <div className="meta-inline-item">
                <img src={iconLocation} alt="Location" className="meta-icon" />
                <span className="sdes jost-font">Airport,Coimbatore</span>
              </div>
            </div>

            <h1 className="project-main-title tit Futura-font">Bharat Petroleum Corporation Limited</h1>
            <p className="project-hero-desc sdes jost-font">
              A executive office design crafted to mirror corporate authority and brand prestige. Featuring illuminated logo branding, high-gloss cabinetry, and ambient ceiling lighting, this space blends professional functionality with a commanding executive presence.
            </p>
      ...
      <section className="property-metrics-bar">
        ...
        <div className="metric-box">
          ...
          <div className="metric-info">
            ...
            <p className="des text-center jost-font">1200 Sq. Ft</p>
          </div>
        </div>
        <div className="metric-box">
          ...
          <div className="metric-info">
            ...
            <p className="des jost-font">North</p>
          </div>
        </div>
      </section>
  ...
  <div className="specs-col-right">
    <p className="narrative-p des jost-font">
      We are currently crafting a refined 1,200 Sq. Ft. interior and exterior solution for Bharat Petroleum Corporation Limited at their Airport, Coimbatore facility, blending architectural clarity with functional precision. This project reflects our commitment to delivering high-performance commercial spaces that are built to impress. With a complete full interior & exterior design scope executed within 60 days, every detail from spatial flow to surface finish is thoughtfully resolved.
    </p>
    <p className="summary-fields-p sdes jost-font">
      <strong className="des">Services:</strong> We are delivering a full-suite interior and exterior design solution designed for commercial excellence and executed with precision.
      <br />
      <strong className="des">Duration:</strong> This project was completed within a swift 60-day timeline, without compromising on quality or detail.
      <br />
      <strong className="des">Total Area:</strong> The space encompasses 1,200 Sq. Ft. of carefully planned, north-facing commercial interior and exterior.
    </p>
  </div>
</section>
...
export default BharatPetroleum;