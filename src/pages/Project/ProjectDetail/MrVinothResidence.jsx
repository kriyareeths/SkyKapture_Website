...
import slider18 from "../../../../src/assets/skykaptureimage6.webp";
import slider19 from "../../../../src/assets/skykaptureimage5.webp";
...
import thirdimage from "../../../../src/assets/Mr Vinoth Residence (5).webp";
import fourthimage from "../../../../src/assets/Mr Vinoth Residence (1).webp";
import fifthimage from "../../../../src/assets/Mr Vinoth Residence (2).webp";


import image1 from "../../../../src/assets/Mr Vinoth Residence (1).webp";
import image2 from "../../../../src/assets/Mr Vinoth Residence (2).webp";
import image3 from "../../../../src/assets/Mr Vinoth Residence (3).webp";
import image4 from "../../../../src/assets/Mr Vinoth Residence (4).webp";
import image5 from "../../../../src/assets/Mr Vinoth Residence (5).webp";
import image6 from "../../../../src/assets/Mr Vinoth Residence (6).webp";
import image7 from "../../../../src/assets/Mr Vinoth Residence (7).webp";
import image8 from "../../../../src/assets/Mr Vinoth Residence (8).webp";



function MrVinothResidence() {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
          ...
          <div className="project-title-wrapper">
            ...
            <div className="client-loc-row">
              <div className="meta-inline-item">
                ...
                <span className="sdes jost-font">Mr.Vinoth</span>
              </div>
              <div className="meta-inline-item">
                <img src={iconLocation} alt="Location" className="meta-icon" />
                <span className="sdes jost-font">Kurumbapalayam, Coimbatore.</span>
              </div>
            </div>

            <h1 className="project-main-title tit Futura-font">Mr.Vinoth Residence</h1>
            <p className="project-hero-desc sdes jost-font">
            A custom designed home crafted to match the lifestyle of its residents. We combined thoughtful spatial planning with elegant interior details to create a warm, functional, and modern living space.
            </p>
      ...
      <section className="property-metrics-bar">
        ...
        <div className="metric-box">
          ...
          <div className="metric-info">
            ...
            <p className="des text-center jost-font">2,500 Sq. Ft</p>
          </div>
        </div>
        <div className="metric-box">
  ...
  <div className="specs-col-left">
    ...
    <ul className="approach-bullet-points">
      ...
      <li className="des jost-font">
        <span className="bullet-sq">▪</span> Turnkey Execution from Concept to Completion
      </li>
      <li className="des jost-font">
  ...
  <div className="specs-col-right">
    <p className="narrative-p des jost-font">
      We are currently crafting a stunning 2,500 Sq. Ft. residence for Mr. Vinoth at Kurumbapalayam, Coimbatore where thoughtful design meets everyday living. This project reflects our commitment to building spaces that feel as beautiful as they function. By weaving together cohesive interior design, material precision, and purposeful layouts, we are transforming this north-facing home into a space that truly belongs to the people within it.
    </p>
    <p className="summary-fields-p sdes jost-font">
      <strong className="des">Services:</strong> Full interior design from spatial planning to the final finishing detail.
      <br />
      <strong className="des">Duration:</strong> Delivered within 60 days of focused, precision-driven execution.
      <br />
      <strong className="des">Total Area:</strong> 2,500 Sq. Ft. of carefully considered, purpose-built living space.
    </p>
  </div>
</section>
...
export default MrVinothResidence;