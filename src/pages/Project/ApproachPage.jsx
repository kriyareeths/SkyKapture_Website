...
import imgResidential from "../../../src/assets/skykaptureimagesanthoshh (9).webp"; 
import imgInteriors from "../../../src/assets/Mr Vinoth Residence (1).webp"; 
import imgCommercial from "../../../src/assets/BPCL (7).webp"; 
import imgStyling from "../../../src/assets/FRONTIMAGE.webp"; 
  ...
  const approachData = [
    {
      ...
      projectsCount: "25+",
      points: [
        "Space Planning That Feels Like Home",
        "Handpicked Furniture & Premium Materials",
        "Light, Color & Texture in Perfect Balance",
        "Smart Living, Seamlessly Integrated",
        "Every Corner Built Around You"
      ],
    ...
    },
    {
      ...
      projectsCount: "15+",
      points: [
        "Strategic Space Planning That Works for Your Business",
        "Every Design Decision Reflects Your Brand Identity",
        "Light, Colour & Texture Chosen With Intention",
        "Spaces Designed Around the People Who Use Them",
        "One Seamless Experience From First Look to Final Finish"
      ],
      image: imgCommercial,
      imageClass: "img-pos-group-odd",
      isReversed: false
    },
    {
      ...
      projectsCount: "40+",
      points: [
        "Thoughtful Space Planning & Visual Flow",
        "Hand-Picked Decor & Statement Accents",
        "Colour, Texture & Material Harmony",
        "Mood Lighting & Ambience Curation",
        "Signature Finishing That Sets Us Apart"
      ],
      image: imgStyling,
      imageClass: "img-pos-group-even",
      isReversed: true
    },
    {
      ...
      projectsCount: "40+",
      points: [
        "Smart Space Planning with Stunning 3D Visualization",
        "Handpicked Products & Premium Material Selections",
        "All-Inclusive Digital Design Packages, Start to Finish",
        "Step-by-Step Implementation Guides & Precise Technical Specs",
        "Seamless Collaboration Through Virtual Design Consultations"
      ],
      image: imgVirtual,
      imageClass: "img-pos-group-odd",
      isReversed: false
